...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#052320] text-slate-300 border-t border-teal-800/40 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                rel="noreferrer"
                aria-label="LinkedIn"
                className="w-9 h-9 rounded-lg bg-teal-900/60 hover:bg-amber-400 hover:text-teal-950 flex items-center justify-center text-slate-300 transition-all duration-200 border border-teal-700/30"
              >
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link to="/" className="text-slate-300 hover:text-amber-300 transition-colors">
                  Home
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/#director" className="text-slate-300 hover:text-amber-300 transition-colors">
                  Director's Desk
                </Link>
              </li>
              <li>
                <Link to="/story" className="text-slate-300 hover:text-amber-300 transition-colors">
                  Our Story & Journey
                </Link>
              </li>
              <li>
                <Link to="/gallery" className="text-slate-300 hover:text-amber-300 transition-colors">
                  Event Gallery
                </Link>
              </li>
              <li>
                <Link to="/team" className="text-slate-300 hover:text-amber-300 transition-colors">
                  Core Team & Mentors
                </Link>
              </li>
              <li>
                <Link to="/incubation" className="text-slate-300 hover:text-amber-300 transition-colors">
                  Incubation Center
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-slate-300/90">
              <li className="flex items-center gap-2">
                <span className="text-amber-400">✓</span> Pre-Incubation MVP Track
              </li>
              <li className="flex items-center gap-2">
                <span className="text-amber-400">✓</span> Up to ₹10L Seed Capital
              </li>
              <li className="flex items-center gap-2">
                <span className="text-amber-400">✓</span> Patent & Legal Filing Support
              </li>
              <li className="flex items-center gap-2">
                <span className="text-amber-400">✓</span> \$100k+ Cloud & Tool Credits
              </li>
              <li className="flex items-center gap-2">
                <span className="text-amber-400">✓</span> Annual Demo Day & Investor Pitch
              </li>
              <li className="flex items-center gap-2">
                <span className="text-amber-400">✓</span> 24/7 Co-working & Hardware Lab
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-slate-300/90">
              ...
              <p className="flex items-center gap-2.5">
                ...
                <a href="mailto:startupcell@iiitbh.ac.in" className="hover:text-amber-300 transition-colors">
        ...
        {/* Bottom bar */}
        <div className="pt-8 mt-8 border-t border-teal-800/40 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-400 gap-4">
          <p>© {currentYear} Startup Cell, IIIT Bhagalpur. All rights reserved.</p>
          <p className="text-teal-300/80">Building the next generation of deep-tech and consumer ventures.</p>
        </div>
      </div>
    </footer>
  );
