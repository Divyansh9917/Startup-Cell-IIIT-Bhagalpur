...
export default function About() {
  return (
    <section id="about" className="scroll-mt-24 bg-[#f4f8f6] py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-14">
          {pillars.map((p) => (
            <div
              key={p.title}
              className="bg-white rounded-2xl p-7 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 border border-teal-900/10 flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-5">
                  ...
                  <span className="text-[11px] font-semibold text-teal-700 bg-teal-100/60 px-2.5 py-0.5 rounded-full">
                    {p.badge}
                  </span>
                </div>
                <h3 className="text-xl font-bold text-[#072e2b] mb-2">
                  {p.title}
                </h3>
        ...
        <div className="bg-gradient-to-r from-[#072e2b] to-[#0d4741] rounded-2xl p-8 sm:p-10 text-white shadow-lg flex flex-col md:flex-row items-center justify-between gap-6 border border-teal-700/30">
          ...
          <div className="flex items-center gap-4 shrink-0">
            <Link
              to="/story"
              className="px-6 py-3 rounded-full text-sm font-semibold border border-teal-400/40 text-white hover:bg-teal-800/60 transition-all"
            >
              Read Our Story
            </Link>
            <Link
              to="/incubation"
              className="px-6 py-3 rounded-full text-sm font-bold bg-amber-400 text-teal-950 hover:bg-amber-300 shadow-md transition-all"
            >
              Apply for Cohort →
            </Link>
          </div>
